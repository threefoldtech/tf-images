            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="page-title-box">
                     ...
                     <h4 class="page-title ">
                        <img class="icon-colored ml-0" src="assets/images/parity.png" title="" alt="colored-icons">
                        Parity - Substrate Node (Beta)
                     </h4>
                     <p>Partiy's Substrate node is now running succesfully on the Three Fold Grid. You can interact with your node by making RPC calls with RPC calls. Please ensure TCP ports 30333, 9933 and 9944 are allowed on your firewall. A sample RPC call is below that you can run from your Linux terminal.</p>
         	...
         	<div class="col-lg-12 col-md-12 col-sm-12">
			   ...
			   <div class="row">
			    <div class="col-lg-12 col-md-4 col-sm-6">
                  <div class="card-boxbg col-md-12" style="background-color: black;color: white;">
                       <div class="col-md-14">
                        <p>curl -H "Content-Type: application/json" --data '{ "jsonrpc":"2.0", "method":"system_health", "params":[],"id":1 }' <span id='getipHtml'></span>:9933</p>
			...
			<div class="row">
               ...
               <div class="col-lg-6 col-md-4 col-sm-6">
                  ...
                  <div class="card-box col-md-12">
                   ...
                   <div class="card-box col-md-12">
                       <div class="col-md-12">
                        <h4>Substrate Daemon Uptime : <span id='NodeUptimeHtml'></span> <img class="icon-flatright" src="assets/images/icons/checkmark.svg" title="checkmark.svg" alt="colored-icons"></h4>
               ...
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card-box col-md-12">
                       ...
                       <div class="col-md-10">
                        <h4>Substrate Node Log 
                           <img class="icon-flat" src="assets/images/icons/checkmark.svg" title="" alt="colored-icons">
                        </h4>
