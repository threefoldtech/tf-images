...
if($serviceRPC=="OK")
{
	...
	echo ' <h4>RPC Service :<span class="green font-16"> Running - TCP port 9933<img class="icon-flatright" src="assets/images/icons/checkmark.svg" title="checkmark.svg" alt="colored-icons"></span></h4>';
