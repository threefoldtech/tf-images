...
tar -czf ubuntu-22.04_fullvm.tar.gz -C ubuntu-jammy .
...
curl -X POST -H "Authorization: Bearer $API_KEY" -F "file=@ubuntu-22.04_fullvm.tar.gz" https://hub.grid.tf/api/flist/me/upload