...
?>
      ...
      <div class="wrapper">
            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="page-title-box">
                     ...
                     <h4 class="page-title ">
                        <img class="icon-colored ml-0" src="assets/images/digibyte-1.png" title="businessman.svg" alt="colored-icons">
                        Digibyte Node Status
                     </h4>
                     <p>Your Digibyte node is now running succesfully on the Three Fold Grid. You can interact with your node by making RPC calls with the RPC credentials provided in the setup. A sample RPC call is below that you can run from your Linux terminal.</p>
		 ...
		 <div class="row">
			...
			<p>kubectl exec -it dgb_pod_name -- bash</p>
			...
			<div class="row">
               ...
               <div class="col-lg-6 col-md-4 col-sm-6">
                  ...
                  <div class="card-box col-md-12">
                   ...
                   <div class="card-box col-md-12">
                       <div class="col-md-12">
                        <h4>Digibyte Daemon Uptime : <span id='NodeUptimeHtml'></span> <img class="icon-flatright" src="assets/images/icons/checkmark.svg" title="checkmark.svg" alt="colored-icons"></h4>
