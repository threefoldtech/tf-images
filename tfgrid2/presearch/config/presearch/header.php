...
<html lang="en">
   <head>
      ...
      <link rel="shortcut icon" type="image/x-icon" href="assets/images/pre-logo.png">
	  
      <title>Presearch Node</title>
      <!-- CSS -->
...
#loader {  
    ...
    z-index: 9999;  
    background: url('assets/images/111.gif') 50% 50% no-repeat rgb(249,249,249);  
}
   ...
   <div id="loader">
		<div style="text-align:center; margin-top:470px;"> <h2>ThreeFold welcomes Presearch Community</h2> </div>
   </div> 
         ...
         <div class="topbar-main">
            <div class="container">
               ...
               <div class="logo" style="float:right; ">                
                  <a href="index.php" class="logo">
                  <img src="assets/images/rightlogo.png" alt="" height="21">
                  </a>
               </div>
               <!-- End Logo container-->
