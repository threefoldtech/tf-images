...
if(!empty($checkblockes)){
	...
	$retrun_data= '<ul class="list-inline chart-detail-list"><p class="font-14"><b>Block Count : '.$checkblockes.'     -      Block Headers : '.$checkheaders.'</b></p>
                                <p>Network hashes per second : '.number_format($checknethash,0).'</p></ul>';
}
else {
	$Percentage=0;
	$retrun_data ='<p class="font-14">Block Count : <span class="text-danger"> 0 </span>  -  Block Headers : <span class="text-danger"> 0 <span></p>
